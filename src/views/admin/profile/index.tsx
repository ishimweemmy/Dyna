    ...
    <div className="w-full grid grid-cols-[50%_50%] pr-5 gap-6 mt-5">
      ...
      <div className="w-full h-full flex flex-col justify-between gap-6 max-h-[80dvh] overflow-scroll">
        ...
        <div className="w-full p-3 flex flex-col gap-8">
          <span className="text-xl font-medium text-navy-700">
          ...
          <form className="w-full grid grid-cols-2 gap-x-5 gap-y-4" noValidate>
            ...
            <button
              disabled
              className="linear rounded-md bg-gray-500 px-4 py-2 text-base font-medium text-white transition duration-200 dark:bg-brand-400 dark:hover:bg-brand-300 dark:active:opacity-90 cursor-not-allowed"
            >
              cancel
            </button>
          </form>
