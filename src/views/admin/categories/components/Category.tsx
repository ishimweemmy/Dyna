...
const Category: FC<TCategory> = ({ id, name, description, subCategories }) => {
  ...
  const { loading, updateCategory, deleteCategory } =
    useCategories();
          ...
          >
            ...
            >
              <div className="w-full flex gap-4 mb-8">
                ...
                <button type="button" className="flex items-center justify-center ml-auto ring-1 p-1 rounded-md ring-brand-500 text-brand-500 hover:text-white hover:bg-brand-500 transition-all" disabled={loading} onClick={() => deleteCategory(id, onClose)}>
                  <TbTrash className="text-lg" />
                  <span className="text-sm">Delete</span>
                </button>                
                <button type="button" className="flex items-center justify-center" disabled={loading} onClick={() => reset()}>
