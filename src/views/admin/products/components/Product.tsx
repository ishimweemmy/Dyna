...
const Product: FC<{ productId: string; tableData: any }> = ({
  productId,
  tableData,
}) => {
  const {
  ...
  return (
    <div>
      ...
      <Modal isOpen={isProductOpen} onClose={onProductClose} isCentered>
        ...
        >
          ...
          <div className="w-full flex items-start justify-center gap-8">
            <div className="w-fit flex flex-col gap-4">
              <Swiper
                ...
                loop
                aria-disabled={false}
                className="h-[20rem] w-[23rem] rounded-lg"
              ...
              <Swiper
                ...
                loop
                aria-disabled={false}
                className="h-[3rem] w-[23rem] rounded-lg"
            ...
            <div className="flex flex-col items-start justify-center gap-4">
              ...
              <span
                className={`text-white text-xs font-bold rounded-full px-2 ${status == "in_stock" ? "bg-green-500" : "bg-brand-500"}`}
              >
                {status == "in_stock" ? "In stock" : "Out of stock"}
              </span>
              <span className="text-sm">
                Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ad
                assumenda autem eaque error explicabo fugiat iusto
                necessitatibus, temporibus. Laudantium, voluptate?
              </span>
          ...
          <div className="flex items-center justify-center gap-3 w-full">
            <button
              className="text-brand-500 border border-brand-500 text-sm p-2 w-1/3 rounded-md self-end my-3 whitespace-nowrap"
              onClick={() => {
                onProductClose();
                onProductEditOpen();
              }}
      ...
      <EditProduct
        ...
        onProductEditClose={onProductEditClose}
      />
    </div>
  );
};
