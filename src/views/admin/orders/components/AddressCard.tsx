...
const AddressCard:FC<{title: string, addressNickname: string, customer: string, address: string, phoneNumber: string}> = ({title, addressNickname, customer, address, phoneNumber}) => {
  return (
