...
export default function SignIn() {
  ...
  return (
    <div className="flex h-[40rem] w-full items-center justify-center lg:items-center lg:justify-start sm-max-2:px-[15%] 2xl:px-[10%] 2xl:max-w-[1600px] lg:px-0 lg:h-full">
      {/* Sign in section */}
      <form onSubmit={handleSubmit(onSubmit)} noValidate className="w-full flex flex-col items-center md:pl-4">
        ...
        <div className="w-full mb-4 flex items-center justify-between px-2">
          ...
          <Link to={"/auth/reset-password"} className="text-sm font-medium text-brand-500 hover:text-brand-600 dark:text-white" >Forgot Password?</Link>
        </div>
        <button disabled={loading} className="linear mt-2 w-full rounded-xl bg-brand-500 py-[12px] text-base font-medium text-white transition duration-200 hover:bg-brand-600 active:bg-brand-700 dark:bg-brand-400 dark:text-white dark:hover:bg-brand-300 dark:active:bg-brand-200 disabled:bg-brand-200">
